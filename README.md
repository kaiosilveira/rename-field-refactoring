...
```bash
yarn tools:cli generate-cmt-table -r rename-field-refactoring
```
...
| Commit SHA                                                                  | Message                  |
| --------------------------------------------------------------------------- | ------------------------ |
| [cmt-sha-1](https://github.com/kaiosilveira/rename-field-refactoring/commit-SHA-1) | description of commit #1 |
| [cmt-sha-2](https://github.com/kaiosilveira/rename-field-refactoring/commit-SHA-2) | description of commit #2 |
| [cmt-sha-n](https://github.com/kaiosilveira/rename-field-refactoring/commit-SHA-n) | description of commit #n |
